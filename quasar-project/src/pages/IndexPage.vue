<template>
  ...
  <div style="height:90vh">
    <q-carousel animated v-model="slide" arrows navigation infinite style="height: 100%">
      ...
      <q-carousel-slide :name="1"  img-src="https://cdn.quasar.dev/img/quasar.jpg" @click.left.shift="slide =2">
        <div align="center">
          <br />
          <input v-model="newUser.name" placeholder="name" @keydown.prevent="handleKeyDown"/><br />
      ...
      <q-carousel-slide :name="2" img-src="https://cdn.quasar.dev/img/parallax1.jpg" align="center" @click.left.shift="slide =3">
        <!-- 단일속성 값이 아닌 객체에는 약어 사용 불가능 -->
        <Qtable v-bind="propsData" @deleteData="deleteUser" />
      </q-carousel-slide>

      <q-carousel-slide :name="3" img-src="https://cdn.quasar.dev/img/mountains.jpg" @click.left.shift="slide =1">
